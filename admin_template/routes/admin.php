...
Route::group(['middleware' => 'admin.auth.admin:admin'], function(){
    ...
    Route::prefix('/search')->as('search.')->group(function () {
        ...
        Route::get('/tag',
        [App\Admin\Http\Controllers\Blog\Tag\TagSearchSelectController::class, 'selectSearch'])->name('tag');
        Route::get('/user',
        [App\Admin\Http\Controllers\User\UserSearchSelectController::class, 'selectSearch'])->name('user');
        Route::get('/admin',
        [App\Admin\Http\Controllers\Admin\AdminSearchSelectController::class, 'selectSearch'])->name('admin');
    });
    });
